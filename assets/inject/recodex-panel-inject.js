...
(() => {
  ...
  const I18N = {
    tw: {
      ...
      "原地复制会话": "原地複製對話", "回答大纲": "回答大綱", "插件市场解锁": "外掛市集解鎖",
      "桌宠跟随真实鼠标": "桌寵跟隨真實滑鼠",
    ...
    ru: {
      ...
      "原地复制会话": "Дублировать чат", "回答大纲": "План ответа", "插件市场解锁": "Разблокировать плагины",
  ...
  const ENH = [
    ...
    ["codexAppSessionCopy", "原地复制会话"],
    ["codexAppAnswerOutline", "回答大纲"],
