...
use codex_plus_core::launcher::{
    ...
    launch_and_inject_with_hooks, macos_app_main_process_pattern,
...
#[test]
fn macos_main_process_pattern_matches_only_the_bundle_main_binary() {
    // pgrep -f 用的是扩展正则:路径里的点、括号必须转义,否则 `Codex (1).app` 这类
