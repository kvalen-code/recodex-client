...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read ReCodex Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse ReCodex Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write ReCodex Zed remote project registry")]
